...
const Head = () => {
    ...
    useEffect(()=>{
       ...
       //but if differece between tow api calls is less than 200ms declined the api call
    ...
    return (
        ...
        <div className='grid grid-cols-4 p-2  m-2 shadow-lg '>
           ...
           <div className='col-span-2 justify-self-center w-full'>
             <input value={searchQuery} onChange={(e)=>setSearchQuery(e.target.value)} className='w-96 p-1 px-4 border border-gray-400 outline-none rounded-l-full' type="text" placeholder='Search....'/>
